...
const isConnected = ({ status }: WiFiStatus) =>
	status === WiFiConnectionStatus.WIFI_STATUS_CONNECTED;
...
const WiFiStatusForm: FC = () => {
	const { loadData, data, errorMessage } = useRest<WiFiStatus>({
		read: WiFiApi.readWiFiStatus,
	});
